...
- `sub-context-docs/brand-profile-narrative.md` — the always-loaded one-pager. **Read it first on every question.** It carries the strategic thesis and points into everything below.
...
- An open strategic question whose list holds only `sub-context-docs/brand-profile-narrative.md` ran too thin. Widen: the newest audit, the personas, the loop it touches, the competitor read that frames it.
