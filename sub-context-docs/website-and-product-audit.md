...
The third one is the finding. **The `quiz.healthformoms.com` destination leaks most of the traffic it is sent.** That ad group bought 903 link clicks and recorded only 234 landing page views, so 74.1% of the paid clicks never registered as arriving. Its cost per lead was $75.72 against an account average of $22.67, and Parker's click-quality score for it was 25.91 against roughly 85 to 90 for the ads pointing at `/save/`. For contrast, the account's biggest spender over the same window, "Moms43 - 4 - V3," bought 21,085 link clicks and recorded 18,413 landing page views, an 87.3% arrival rate, at a $22.21 cost per lead. (`verified`, Parker MCP ad pull, last 90 days.)

Against the brand's own scoreboard, where under $15 is "fantastic," $15 to $20 is "good," $20 to $25 is "meh," and over $25 is "not good" (`stated`, brand context Section 11), a $75.72 cost per lead is not a soft miss. It is three times the failure line. The ad group is currently in an `ADSET_PAUSED` state, so someone may already have caught it. Whether the leak is a redirect problem, a slow page, a tracking gap, or a genuinely worse quiz is not knowable from the outside, and it is one of the open loops below.
...
One ad group in the window pointed at `quiz.healthformoms.com`, a different domain from the main site. It bought 903 link clicks and recorded 234 landing page views, so about three quarters of the traffic never showed up, and its cost per lead was $75.72 against an account average of $22.67.
