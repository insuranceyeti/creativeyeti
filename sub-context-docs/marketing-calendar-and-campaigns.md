...
**The `go.healthformoms.co` funnel break, live from 2026-08-17.** The ad "Moms Nahuel WV#1 - V9 - Copy" was pointed at a second subdomain rather than the usual `/save/` page. It bought 690 link clicks and recorded only 63 landing page views, a 9.1% landing rate, and its cost per lead came in at $273.23 against an account average of $22.67. The identical video file on `www.` converted 80.3% at $19.25. **Verified** by ad-level pull, 2026-09-04. It belongs in this section because a funnel swap is the closest thing this brand has to a product launch — but this one is a fault, not a test, and it has not wound down: 11 active ads still point there.
...
**What plays the role of a launch is a funnel change.** Choosing which landing destination an ad points at is, per the product audit, the highest-leverage product decision anyone at this brand makes. Three destinations appear in the account: `https://www.healthformoms.co/save/`, which is the workhorse carrying nearly every ad; a `/save-cw` variant; and `https://quiz.healthformoms.com/#/indvfam`, on a different domain entirely. The `go.` subdomain is the datable funnel event in the current window: live from **2026-08-17** on "Moms Nahuel WV#1 - V9 - Copy," it lost 90.9% of the clicks it bought before they registered as arrivals and produced a $273.23 cost per lead, against $19.25 for the identical file on `www.`. The quiz subdomain is a separate brand-new test at $138.27 lifetime and is unmeasured. **Verified** by ad-level pull, 2026-09-04.
